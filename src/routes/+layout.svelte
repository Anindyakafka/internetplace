<script lang="ts">
	...
	const socialMetaByPath: Record<string, SocialMeta> = {
		...
		'/kolkata-water-log': { title: 'Kolkata Water Log — Anindya Singh', description: 'Terrain-derived water-flow and accumulation patterns across Kolkata, read alongside documented waterlogging reports.', image: '/images/sections/kolkata-water-log.jpg', imageAlt: 'A terrain-derived network of possible water accumulation paths across Kolkata' },
