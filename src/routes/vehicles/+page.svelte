<script lang="ts">
	...
	function drawVehicles() {
		...
		const halfWidth = zoom >= 14 ? 2.4 : zoom >= 12 ? 2 : 1.5;
		const halfHeight = zoom >= 14 ? 1.25 : 0.9;
