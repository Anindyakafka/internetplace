<script lang="ts">
	...
	const routes: Record<string, string> = {
		...
		sections: '/sections', map: '/map', tracks: '/tracks', trains: '/trains', vehicles: '/vehicles', water: '/kolkata-water-log',
	...
	function submit() {
		...
		else if (base === 'ls') add('about work writing colophon sections map tracks trains vehicles water contact');
		else if (base === 'cd') {
